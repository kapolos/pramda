...
class P
{
    ...
    const lte = 'P::lte';
    const map = 'P::map';
    const mathMod = 'P::mathMod';
    const max = 'P::max';
    const maxBy = 'P::maxBy';
    const merge = 'P::merge';
    const mergeAll = 'P::mergeAll';
    const min = 'P::min';
    const minBy = 'P::minBy';
    ...
    const pipe = 'P::pipe';
    const pluck = 'P::pluck';
    const prepend = 'P::prepend';
    const prependTo = 'P::prependTo';
    const product = 'P::product';
    const prop = 'P::prop';
    const propOf = 'P::propOf';
    const propOr = 'P::propOr';
    const props = 'P::props';
    ...
    const tail = 'P::tail';
    const take = 'P::take';
    const takeLast = 'P::takeLast';
    const takeWhile = 'P::takeWhile';
